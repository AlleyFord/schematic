...
> **Note:** **⚠️ ARCHIVED:** This repository is archived. Active development has moved to [`@anchovie/schematic`](https://github.com/anchovie/schematic). Please use the new package for latest features and bug fixes.
